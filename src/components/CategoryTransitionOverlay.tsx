...
export const CategoryTransitionOverlay: React.FC<CategoryTransitionOverlayProps> = ({
  ...
  useEffect(() => {
    ...
    // After 2.8 s trigger the closing slide-up animation
  ...
  return (
    ...
    >
      {/* Dark background that matches the rest of the app */}
      ...
      {/* Category thumbnail – large circular image */}
      <div
        style={{
          width: '180px',
          height: '180px',
      ...
      {/* Thin golden horizontal rule – decorative */}
      <div
        className="text-fade-up-2"
        style={{
          marginTop: '28px',
